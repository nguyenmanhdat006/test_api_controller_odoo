...
class MyPetAPI(odoo.http.Controller):
    @odoo.http.route(['/pet/<dbname>/<id>'], type='http', auth="none", methods=['GET'], sitemap=False, cors='*', csrf=False)
    ...
    @odoo.http.route(['/pet/<dbname>'], type='json', auth="none", methods=['POST'], csrf=False)
    ...
    @odoo.http.route(['/pet/<dbname>/<id>'], type='json', auth="none", methods=['PUT'], csrf=False)
    ...
    @odoo.http.route(['/pet/<dbname>/<id>'], type='json', auth="none", methods=['DELETE'], csrf=False)
